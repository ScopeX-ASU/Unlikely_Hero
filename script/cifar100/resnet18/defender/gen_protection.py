...
root = "Experiment/log/cifar100/resnet18/defender/new_sampling"
script = "scan_unary_defender.py"
config_file = "config/cifar100/resnet18/defender/defender.yml"
...
if __name__ == "__main__":
    ...
    tasks = [
        (
            8,
            "taylor-series",        # Use taylor series to determine sensitivity
            "IS"    # Choose IS as Importance-Samping and Even as even budget distribution
        )
    ]
