...
def scan_grad_attacker(
    ...
    folder = f"./log/defense-exist/{configs.model.name}/Weight_Percentage/Importance_sampling"
    ensure_dir(folder)
    np.savetxt(
        os.path.join(
...
if __name__ == "__main__":
    ...
    for w_per in W_per:
        ...
        file_Path = os.path.join(
            f"./log/defender/{configs.model.name}/Weight_Percentage/Importance_sampling",
